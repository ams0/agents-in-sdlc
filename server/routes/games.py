...
including individual games and collections of games with their
...
def get_games_base_query() -> Query:
    """
    Creates the base query for games with joined publisher and category data.
...
def get_game(id: int) -> tuple[Response, int] | Response:
    """
    Retrieves a specific game by its ID with publisher and category information.
