...
def create_game() -> tuple[Response, int]:
    """Create a new game with validation and error handling"""
    try:
        # Get JSON data from request - use force=True to handle missing Content-Type
        ...
        # Return the created game using the base query to get full details
...
def update_game(id: int) -> tuple[Response, int]:
    """Update an existing game with validation and error handling"""
    try:
        ...
        # Return the updated game using the base query to get full details
